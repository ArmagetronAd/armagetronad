...
static tCallbackScripting * rPerFrameTaskScripting_anchor;
    #endif
...
void rPerFrameTask::DoPerFrameTasks(){
    ...
    #ifdef ENABLE_SCRIPTING
rPerFrameTaskScripting::rPerFrameTaskScripting()
        :tCallbackScripting(rPerFrameTaskScripting_anchor)
{
}

void rPerFrameTaskScripting::DoPerFrameTasks(){
    rNoAutoDisplayAtNewlineCallback noAutoDisplay( sr_True );
    Exec(rPerFrameTaskScripting_anchor);
}
    #endif
