...
private:
    ...
    virtual void OnDropTempWall        ( gPlayerWall * wall, eCoord const & position );   //!< called when another cycle grinds a wall; this cycle should then drop its current wall if the grinding is too close.
