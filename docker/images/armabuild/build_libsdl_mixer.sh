...
rm ${archive}.tar.gz
cd ${archive}
CFLAGS=-Os ./configure --prefix=/usr/ --enable-music-ogg --disable-music-ogg-shared --disable-music-mod --disable-music-flac --disable-music-midi --disable-music-mp3 --disable-music-mp3-mpg123 --disable-music-opus || exit $?
make -j 5 || exit $?
make install || exit $?
cd .. && rm -rf ${archive}
