...
"make cvscheck" runs beautification and "make installcheck".
...
z-man's advice: Before committing your work to CVS, please run at least "make cvscheck", it only takes some seconds. Run "make fullcheck" when you have made changes to the build system.
